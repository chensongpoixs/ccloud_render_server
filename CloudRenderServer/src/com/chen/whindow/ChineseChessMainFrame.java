...
import com.chen.whindow.LabelEvent.ChessPieceClick;
import com.chen.chessBoard.ChessBoarder;
import com.chen.defultSet.DefultSet;
...
///imageLibary/Menu4_1.png
			Image image = Toolkit.getDefaultToolkit().getImage(ChineseChessMainFrame.class.getResource("/imageLibary/black-pao.png"));
			//2.停留提示text
			...
			});//new Font("华文行楷",Font.CENTER_BASELINE,28)
